...
//Do for pair portal only use
public class PortalCamera : MonoBehaviour
{
    [SerializeField]
    private PortalForPair[] portals = new PortalForPair[2];
    ...
    private void RenderCamera(PortalForPair inPortal, PortalForPair outPortal, int iterationID, ScriptableRenderContext SRC)
    {
